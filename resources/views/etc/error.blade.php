...
<body>
    ...
    <main class="page fade-in">
        <div id="top-bar" class="top-bar">
            <span class="action-btn action-btn_primary"><a href="rsreksawaluya.com">&larr; back home</a></span>
        ...
        <div class="flex-container" id="error-message">
            <div>
                <h1>500</h1>
                <h2>Oooops! Data Error ! Silahkan hubungi kami untuk info lebih lanjut </h2>
            </div>
            <div>
                <p>
